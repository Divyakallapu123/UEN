...
function create_custom_post_type_category() {
    ...
    $labels = array(
        'name'              => _x( 'category Categories', 'phoronesis' ),
        'singular_name'     => _x( 'category Category', 'phoronesis' ),
    ...
    register_taxonomy( 'category-category', array( 'category' ) , $args );

   }
add_action( 'init', 'create_custom_post_type_category' );
?>